	...
	public function handle($request, Closure $next)
	{
		if (App::make('Settings')->get('enablePushState')) {
            ...
            Route::group(['middleware' => 'prerender'], function () {
                ...
                Route::get('artist/{id}/{name}', 'App\Http\Controllers\HomeController@index');
                Route::get('album/{album}', 'App\Http\Controllers\HomeController@index');
                Route::get('album/{artist}/{album}', 'App\Http\Controllers\HomeController@index');
                Route::get('album/{albumId}/{artist}/{album}', 'App\Http\Controllers\HomeController@index');
                ...
                Route::get('genre/{name}', 'App\Http\Controllers\HomeController@index');
                Route::get('new-releases', 'App\Http\Controllers\HomeController@index');
                Route::get('popular-genres', 'App\Http\Controllers\HomeController@index');
                Route::get('popular-albums', 'App\Http\Controllers\HomeController@index');
                Route::get('top-songs', 'App\Http\Controllers\HomeController@index');
                Route::get('top-albums', 'App\Http\Controllers\HomeController@index');
            });
